...
bool dilate(unsigned char * valuecheck)
{// structure check=010111010
	if(valuecheck[0]==0 && valuecheck[2]==0 && valuecheck[6]==0 && valuecheck[8]==0 && (valuecheck[1] || valuecheck[3] || valuecheck[4] || valuecheck[5] || valuecheck[7])==1)
	{
		return (true);
	}
	else 
